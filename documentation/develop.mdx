...
title: Develop
description: Learn how to contribute to Auk.
---

We love your input! We want to make contributing to Auk as easy and transparent as possible, whether it's:
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/auk/auk)

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/mamahuhu-io/auk)
...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/mamahuhu-io/auk/issues); it's that easy!
...
By contributing, you agree that your contributions will be licensed under [MIT License](https://github.com/mamahuhu-io/auk/blob/main/LICENSE).
