...
description: Configure client certificates for SSL authentication in Auk.
---

Add and manage client certificates in [Auk Desktop App](https://auk.mamahuhu.io/download) or in a self-hosted Auk web instance using the [Auk Agent](/documentation/features/interceptor#auk-agent) as an interceptor to authenticate your identity when connecting to secure APIs.

### Prerequisites

Before you begin, ensure you have the following:

- Either the **Auk Desktop App** installed on your system, or if you are using the Auk Web App, make sure the **Auk Agent** is installed and configured.
...
1. Open Auk's settings page from the side bar.
