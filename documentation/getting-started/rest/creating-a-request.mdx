...
description: Learn how to create a request in Auk.
---

The RESTful protocol is the default protocol that is active when you open Auk. Auk allows you to make API requests and examine the responses.
