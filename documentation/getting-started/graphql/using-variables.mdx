...
Auk allows you to pass variables in the query to fetch data dynamically.
...
Auk will retrieve the value of the variable and execute the query to get the below response.
