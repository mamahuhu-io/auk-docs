...
description: Learn how to run a simple query using Auk.
---

## Connecting to a GraphQL server

Switch to the GraphQL platform on Auk and connect to a public GraphQL server, for example:

```
https://countries.trevorblades.com/graphql
```

Once a successful connection has been made, you can view both **documentation** and the **schema** using Auk.
...
1. Open Auk, switch to the GraphQL client and connect to the endpoint:
