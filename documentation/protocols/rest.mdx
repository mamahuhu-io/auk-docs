...
title: RESTful
description: RESTful API testing with Auk.
---

## Platform

Auk has a built-in REST platform that can be used to execute REST API requests. The REST platform can be accessed by clicking on the `REST` tab in the menu.
...
Auk's REST API platform provides you with a fast and seamless experience to test and debug your API endpoints.
...
Auk also provides the capability to run `Tests` on the responses you receive.
