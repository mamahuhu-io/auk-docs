...
title: Realtime
description: Auk's Realtime API platform helps you test your real-time APIs easily.
---

## Platform

Auk has a built-in real-time platform that can be used to execute real-time requests. The real-time client platform can be accessed by clicking on the `Realtime` tab in the left sidebar.
...
With Auk you can work with the following real-time protocols:
...
Auk's Realtime API platform helps you test your real-time APIs easily.
